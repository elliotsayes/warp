...
export declare abstract class DefaultStateEvaluator implements StateEvaluator {
    ...
    evalHistory<State>(executionContext: ExecutionContext<State, HandlerApi<State>>): Promise<SortKeyCacheResult<EvalStateResult<State>>[]>;
    protected doReadStateHistory<State>(missingInteractions: GQLNodeInterface[], baseState: EvalStateResult<State>, executionContext: ExecutionContext<State, HandlerApi<State>>): Promise<SortKeyCacheResult<EvalStateResult<State>>[]>;
    private logResult;
    private parseInput;
