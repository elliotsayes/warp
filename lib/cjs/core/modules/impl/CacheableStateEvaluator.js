...
class CacheableStateEvaluator extends DefaultStateEvaluator_1.DefaultStateEvaluator {
    ...
    async eval(executionContext) {
        ...
        return await this.doReadStateHistory(missingInteractions, new StateEvaluator_1.EvalStateResult(baseState, baseValidity, baseErrorMessages || {}), executionContext).then((results) => results[results.length - 1]);
    }
